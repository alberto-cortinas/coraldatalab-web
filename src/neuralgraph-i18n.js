...
export const neuralGraphCopy = {
  es: {
    ...
    productTitle: 'Infraestructura para RAG en producción e inteligencia de grafos.',
    productLead: 'Un motor nativo en Rust que explora RAG, GraphRAG, embeddings y algoritmos de grafos como una sola plataforma operativa.',
    researchCta: 'Participar en la investigación', talkCta: 'Hablar con el equipo',
    problemLabel: 'El problema', problemTitle: 'RAG llega rápido a la demo. Operarlo en producción es otra historia.',
    ...
    solutionLabel: 'La propuesta de NeuralGraph', evidenceLabel: 'Evidencia futura',
    evidenceIntro: 'Publicaremos datos reales conforme avancemos en la validación.',
    evidenceItems: ['Calidad de recuperación', 'Coste por consulta', 'Latencia extremo a extremo'], evidenceValue: 'En validación',
  ...
  ca: {
    ...
    productTitle: 'Infraestructura per a RAG en producció i intel·ligència de grafs.',
    productLead: 'Un motor natiu en Rust que explora RAG, GraphRAG, embeddings i algoritmes de grafs com una única plataforma operativa.',
    researchCta: 'Participar en la recerca', talkCta: 'Parlar amb l’equip',
    problemLabel: 'El problema', problemTitle: 'RAG arriba ràpid a la demo. Operar-lo en producció és una altra història.',
    ...
    solutionLabel: 'La proposta de NeuralGraph', evidenceLabel: 'Evidència futura',
    evidenceIntro: 'Publicarem dades reals a mesura que avancem en la validació.',
    evidenceItems: ['Qualitat de recuperació', 'Cost per consulta', 'Latència d’extrem a extrem'], evidenceValue: 'En validació',
  ...
  en: {
    ...
    productTitle: 'Infrastructure for production RAG and graph intelligence.',
    productLead: 'A Rust-native engine exploring RAG, GraphRAG, embeddings and graph algorithms as one operational platform.',
    researchCta: 'Join the research', talkCta: 'Talk to the team',
    problemLabel: 'The problem', problemTitle: 'RAG reaches the demo quickly. Operating it in production is another story.',
    ...
    solutionLabel: 'The NeuralGraph proposition', evidenceLabel: 'Future evidence',
    evidenceIntro: 'We will publish real data as validation progresses.',
    evidenceItems: ['Retrieval quality', 'Cost per query', 'End-to-end latency'], evidenceValue: 'In validation',
